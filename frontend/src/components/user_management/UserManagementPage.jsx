    ...
    <div className="min-h-screen bg-gray-100 flex py-8">
      <div className="w-full bg-white shadow-lg rounded-lg p-6 m-4">
        ...
        <div className="flex justify-end mb-4">
          ...
          <button 
            onClick={generatePDF} 
            className="bg-blue-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-600 ml-4"
          >
            Generate Report
          </button>
        </div>
          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead>
              <tr>
                ...
                <th className="py-2 px-4 border-b font-semibold text-gray-700">Email</th>
                <th className="py-2 px-4 border-b font-semibold text-gray-700">Role</th>
                <th className="py-2 px-4 border-b font-semibold text-gray-700">Address</th>
                <th className="py-2 px-4 border-b font-semibold text-gray-700">Actions</th>
              </tr>
            </thead>
            <tbody>
              {users.map(user => (
                <tr key={user.id} className="text-center">
                  ...
                  <td className="py-2 px-4 border-b text-gray-700">{user.email}</td>
                  <td className="py-2 px-4 border-b text-gray-700">{user.role}</td>
                  <td className="py-2 px-4 border-b text-gray-700">{user.address}</td>
                  <td className="py-2 px-4 border-b">
                    <div className="flex justify-center space-x-2">
                      <button
                        onClick={() => deleteUser(user.id)}
                        className="bg-red-500 text-white font-bold py-1 px-3 rounded-lg hover:bg-red-600 w-full"
                      >
                        Delete
                      </button>
                      <Link
                        to={`/update-user/${user.id}`}
                        className="bg-blue-500 text-white font-bold py-1 px-3 rounded-lg hover:bg-blue-600 w-full"
                      >
                        Update
                      </Link>
                    </div>
